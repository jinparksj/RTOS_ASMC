/*
  RS485HwSerial.cpp - Hardware serial library for Wiring
...
// this next line disables the entire RS485HwSerial.cpp,
// this is so I can support Attiny series and any other chip without a uart
#if defined(HAVE_RS485HWSERIAL0) || defined(HAVE_RS485HWSERIAL1) || defined(HAVE_RS485HWSERIAL2) || defined(HAVE_RS485HWSERIAL3)

// SerialEvent functions are weak, so when the user doesn't define them,
// the linker just sets their address to 0 (which is checked below).
// The Serialx_available is just a wrapper around Serialx.available(),
// but we can refer to it weakly so we don't pull in the entire
// RS485HwSerial instance if the user doesn't also refer to it.
#if defined(HAVE_RS485HWSERIAL0)
  void serialEvent() __attribute__((weak));
  bool Serial0_available() __attribute__((weak));
#endif

#if defined(HAVE_RS485HWSERIAL1)
  void serialEvent1() __attribute__((weak));
  bool Serial1_available() __attribute__((weak));
#endif

//#if defined(HAVE_RS485HWSERIAL2)
